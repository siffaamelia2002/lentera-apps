    ...
    <div className="w-full lg:w-1/2 flex flex-col justify-center items-center bg-slate-950 min-h-screen relative overflow-hidden">
      ...
      <div className="w-full sm:max-w-[480px] z-10 relative flex flex-col justify-center min-h-screen sm:min-h-fit">
        <div className="bg-slate-950/60 sm:bg-slate-900/80 backdrop-blur-xl sm:backdrop-blur-2xl px-6 py-12 sm:p-14 sm:rounded-[3rem] sm:shadow-[0_40px_80px_-15px_rgba(0,0,0,0.5)] border-y border-transparent sm:border sm:border-slate-800 relative overflow-hidden flex flex-col justify-center min-h-screen sm:min-h-fit transition-all duration-500 hover:shadow-[0_50px_100px_-20px_rgba(0,0,0,0.6)] group/card">
          ...
          {/* Accent Line */}
          <div className="hidden sm:block absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-slate-600 to-emerald-500" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  <div className="absolute left-4.5 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-emerald-500 transition-colors duration-300">
                    <Mail size={18} />
                  </div>
                  <input 
                    type="email" 
                    ...
                    className="w-full pl-12 pr-5 py-4 rounded-2xl bg-slate-950/50 border border-slate-800 text-white placeholder:text-slate-600 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 outline-none transition-all duration-300 font-semibold text-base sm:text-sm shadow-inner"
              ...
              <div className="space-y-2">
                ...
                <div className="relative group">
                  ...
                  <input 
                    ...
                    required
                    placeholder="••••••••••••"
                    className="w-full pl-12 pr-14 py-4 rounded-2xl bg-slate-950/50 border border-slate-800 text-white placeholder:text-slate-600 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 outline-none transition-all duration-300 font-semibold text-base sm:text-sm shadow-inner"
              ...
              <div className="flex items-center justify-between text-[13px] px-1.5 pt-1">
                <div className="flex items-center space-x-2.5 group">
                  <button 
                    ...
                    className={`peer h-4.5 w-4.5 shrink-0 rounded-[4px] border transition-all duration-200 flex items-center justify-center outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/50
                      ${formData.remember 
                ...
                <Link href="/lupa-sandi" className="font-bold text-emerald-500 hover:text-emerald-400 transition-colors">
                  Lupa sandi?
                </Link>
              </div>
              ...
              <button 
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-bold text-[15px] py-4.5 rounded-2xl transition-all duration-500 shadow-[0_15px_30px_-5px_rgba(16,185,129,0.25)] disabled:opacity-70 flex items-center justify-center gap-3 mt-5 active:scale-[0.98] group/btn overflow-hidden relative"
              >
                {isLoading ? (
